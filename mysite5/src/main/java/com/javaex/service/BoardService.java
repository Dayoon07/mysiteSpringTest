...
public class BoardService {
	...
	public List<BoardVo> searchBoard(int startRow, int pageSize, String keyword) {
		return boardDao.searchBoard(startRow, pageSize, keyword);
	}
	
	public List<BoardVo> exeList(int offset, int numPerPage) {
		return boardDao.exeList(offset, numPerPage);
	}
	...
	public int countTotalPosts() {
		return boardDao.countTotalPosts();
	}
	
	public int countTotalPosts(String keyword) {
		return boardDao.countTotalPosts(keyword);
	}
